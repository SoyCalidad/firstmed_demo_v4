...
class AccountMoveReversal(models.TransientModel):
    ...
    journal_id = fields.Many2one('account.journal', string='Use Specific Journal', help='If empty, uses the journal of the journal entry to be reversed.',domain=[('l10n_latam_document_type_id','=', '07')])
