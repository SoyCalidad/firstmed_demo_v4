...
# 				data['id_factura'] = invoice.id
# 				data['correlativo_factura'] = invoice.name
# 				data['share_link'] = invoice.share_link
# 				data['origin'] = invoice.invoice_origin
# 				_logger.info(data)
# 				requests.post('https://bitrixdemo.site/odoo/factura.php', data=data)
# 		return res
...
class AccountMove(models.Model):
	...
	def action_post(self):
		...
		share_link = self.share_link if hasattr(self, 'share_link') else ''
		data = {
			'id_factura': self.id,
			'correlativo_factura': self.name,
